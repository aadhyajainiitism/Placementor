  ...
  return (
    <>
      ...
      <Div>
        ...
        <BodyLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2023">
          2023
        </BodyLink>
      </Div>


      {/* <Soon>Coming Soon ❤️</Soon> */}
      <CompanyFetch url="placement23" query={query} type="placement23" year="2023" branch={Branch} />
    </>
  );
}
